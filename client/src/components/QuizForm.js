        ...
        const QuizForm = ({allDinosaurs, answers, setValue, onSubmit}) => {
            ...
            const quizDinos = allDinosaurs.map((dino, index) => {
                return (
                    ...
                    <img style ={{width: 160,height: 160}} src={`../image/${dino.img}`} alt={dino.name}/>
                    </div>
